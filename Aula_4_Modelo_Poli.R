...
#Estima o modelo de tendência poli
...
#plota o grafico da serie temporal de treinamento e teste
plot(modelo_tendencia_poli_proj, xlab="Tempo", ylab="Passageiros", xaxt="n" , ylim=c(1300, 2300), xlim=c(1991, 2006.25), bty="l", flty=2,main="Forecast from Polynomial regression model")
...
modelo_tendencia_poli_final <- tslm(passageiros_ts ~ trend + I(trend^2))
...
#plota o grafico da serie temporal de treinamento e teste
plot(modelo_tendencia_poli_final_proj, xlab="Tempo", ylab="Passageiros", ylim=c(1300, 2800), xlim=c(1991, 2007), bty="l", flty=2, main="Forecast from Polynomial regression model")
