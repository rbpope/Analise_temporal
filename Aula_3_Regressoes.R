...
#plota o grafico da serie temporal de treinamento e teste
plot(modelo_tendencia_linear_proj, xlab="Tempo", ylab="Passageiros", xaxt="n" , ylim=c(1300, 2300), xlim=c(1991, 2006.25), bty="l", flty=2)
...
modelo_tendencia_linear_final <- tslm(passageiros_ts ~ trend)
...
#plota o grafico da serie temporal de treinamento e teste
plot(modelo_tendencia_linear_final_proj, xlab="Tempo", ylab="Passageiros", ylim=c(1300, 2300), xlim=c(1991, 2007), bty="l", flty=2)
axis(1, at=seq(1991, 2007, 1), labels=format(seq(1991, 2007,1)))
lines(modelo_tendencia_linear_final_proj$fitted, lwd=2, col="blue")
